...
public class FetchAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        try {
            ...
            Double lat = intent.getParcelableExtra(AppUtils.LocationConstants.LOCATION_LATITUDE);
            Double lng = intent.getParcelableExtra(AppUtils.LocationConstants.LOCATION_LONGITUDE);
